  ...
  return (
    <div className='min-h-screen flex' style={{ backgroundColor: '#0D0D0D' }}>
      ...
      <div className='hidden lg:flex lg:w-[55%] flex-col justify-between p-14 relative overflow-hidden'>
        ...
        {/* Blob de luz roja */}
        <div className='absolute inset-0 pointer-events-none' style={{
          background: 'radial-gradient(ellipse at 30% 40%, rgba(192,57,43,0.09) 0%, transparent 65%)',
        }} />
        ...
        {/* Logo — cápsula blanca, se ve perfecto sobre negro */}
        ...
        <div className='relative z-10'>
          ...
          <div className='flex gap-10 mb-10'>
            {[
              ...
              { label: 'disponibilidad',          el: <span>24/7</span> },
              { label: 'llamadas para coordinar', el: <span>0</span> },
            ].map(({ label, el }) => (
              <div key={label}>
        ...
        <div className='relative z-10 space-y-4'>
          <blockquote className='pl-4 text-sm text-gray-500 italic leading-relaxed'
            style={{ borderLeft: '2px solid #C0392B' }}>
            "Antes perdíamos citas por no contestar el teléfono.<br />Ahora todo es automático."
          </blockquote>
          <p className='text-xs text-gray-600'>— Cliente desde 2024 · Arequipa, Perú</p>
