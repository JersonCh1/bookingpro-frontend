...
import { Calendar, CheckCircle, Zap, Shield, Bell } from 'lucide-react'
...
const BENEFITS = [
  ...
  { icon: Bell,   text: 'Notificaciones automáticas por WhatsApp' },
  { icon: Shield, text: 'Sin contratos ni permanencia' },
]
...
export default function Register() {
  ...
  return (
    <div className='min-h-screen flex'>
      ...
      >
        ...
        <div>
          ...
          <p className='text-white/70 mb-10'>
            Empieza a recibir reservas online hoy mismo. Sin instalaciones, sin complicaciones.
          </p>
          ...
          <p className='mt-10 text-white/40 text-sm'>S/. 80/mes · Sin contrato · Cancela cuando quieras</p>
        </div>
      ...
      <div className='w-full lg:w-7/12 flex items-start justify-center bg-white px-8 py-10 overflow-y-auto'>
        <div className='w-full max-w-lg'>
          ...
          <p className='text-gray-500 text-sm mb-7'>Configura tu negocio en menos de 2 minutos</p>
